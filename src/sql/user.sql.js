const userSql = {
    getAllUsers: 'SELECT id, first_name, last_name, username, email, role FROM users WHERE deleted_at IS NULL;',
    getUserById: 'SELECT id, first_name, last_name, username, email, role FROM users WHERE id = $1',
    ...
    checkIfUserIsDeleted: 'SELECT deleted_at FROM users WHERE id = $1',
};
